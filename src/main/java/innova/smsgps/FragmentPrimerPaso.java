...
//                dialog.cancel();
            ...
            txtUserName.setText("");
            managerUtils.imprimirToast(getActivity(), "Sesi�n no iniciada..");
...
//        });
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            case R.id.btnAceptar:
                if (isSessionWithFacebook())
                {
                    managerUtils.imprimirToast(getActivity(), "Sesi�n iniciada correctamente..");
                }else
                {
                    managerUtils.imprimirToast(getActivity(), "A�n no inicia su sesi�n..");
                }
                break;
        }
    }
    ...
    /**
     * Simple funci�n booleana que nos indicar�
     * si tenemos guardada una sesi�n...
     **/
